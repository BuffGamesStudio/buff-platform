...
write_metadata() {
  local classification="$1"
  {
    ...
    echo "raw_composition_sha=bcaa2c5a15ea74b0b2ad7de56b411405310f1dd1"
    echo "raw_composition_tree=877b971b07fa1b509979c6dc1c7bd171850eaae3"
    ...
    echo "component_mov16_sha=8c28d2ba24283f3529dc52aef1c335ab58d99edb"
    echo "component_mov16_tree=73bffa36d16bf784c905444751e5bc5740a2aa07"
