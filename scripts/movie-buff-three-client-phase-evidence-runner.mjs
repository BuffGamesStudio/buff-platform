...
const sourceFiles = [
  ...
  "supabase/migrations/20260804083610_movie_buff_match_start_handoff_digest_repair.sql",
  ...
  "supabase/rollbacks/20260804083610_movie_buff_match_start_handoff_digest_repair.rollback.sql",
