-- Hosted Movie Buff source-registry patch
-- Date: Friday, July 31, 2026
-- Purpose:
--   Bring hosted admin/source-registry parity up to the same schema and grants
--   already proven locally for `/admin/sources`.
