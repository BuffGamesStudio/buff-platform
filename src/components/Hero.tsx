...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-black via-zinc-950 to-black">
      ...
      <div className="relative mx-auto flex min-h-[90vh] max-w-7xl flex-col items-center justify-center px-8 py-24 text-center">
        ...
        <h1 className="max-w-5xl text-6xl font-black leading-tight text-white md:text-7xl xl:text-8xl">
          PLAY WHAT
          <span className="block text-red-500">YOU LOVE</span>
        </h1>
        ...
        <div className="mt-12 flex flex-col gap-5 sm:flex-row">
          ...
          <button className="flex items-center justify-center gap-3 rounded-xl bg-red-600 px-8 py-4 text-lg font-bold text-white transition hover:bg-red-700">
            <PlayCircle size={22} />
            Play Movie Buff
          </button>

          <button className="flex items-center justify-center gap-3 rounded-xl border border-zinc-700 px-8 py-4 text-lg font-bold text-white transition hover:border-red-500 hover:text-red-400">
            Learn More
            <ArrowRight size={20} />
          </button>
        ...
        <div className="mt-20 grid w-full max-w-5xl gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
            <h2 className="text-4xl font-black text-red-500">25K+</h2>
            <p className="mt-2 text-zinc-400">Players Expected at Launch</p>
          </div>

          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
            <h2 className="text-4xl font-black text-red-500">1000+</h2>
            <p className="mt-2 text-zinc-400">Movie & TV Challenges</p>
          </div>

          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 backdrop-blur">
            <h2 className="text-4xl font-black text-red-500">24/7</h2>
            <p className="mt-2 text-zinc-400">Competitive Multiplayer</p>
          </div>
