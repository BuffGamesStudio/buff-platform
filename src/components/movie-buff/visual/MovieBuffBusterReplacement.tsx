...
export function MovieBuffBusterReplacement({
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-3xl border border-amber-300/35 bg-[radial-gradient(circle_at_top,_rgba(245,158,11,0.18),_transparent_56%),linear-gradient(145deg,#18110a,#090909_62%)] p-6 text-white shadow-2xl"
    >
