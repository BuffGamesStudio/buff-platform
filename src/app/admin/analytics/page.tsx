  ...
  const sections = [
    {
      ...
      description:
        "Movie records, source metadata, and clip inventory.",
    },
    {
      ...
      description:
        "Difficulty, hint rate, solve time, and recent clip behavior.",
    },
    {
      ...
      description:
        "Admin boost, live rotation status, and weighted selection inputs.",
    },
    {
      ...
      description:
        "Broken playback, weak clips, and obvious or giveaway content.",
    },
    {
      ...
      description:
        "Round event history, room flow, and recent live usage.",
    },
  ];
