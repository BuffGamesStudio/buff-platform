...
-- generated: 2026-07-31T01:14:47.6505812-04:00
...
-- >>> BEGIN 202607292300_movie_buff_enter_round_gate.sql
create or replace function public.get_movie_buff_round(
  p_room_id uuid
)
returns table (
...
-- >>> BEGIN 20260811185746_movie_buff_shared_playback_clock_sync.sql
create or replace function public.get_movie_buff_round_player_time_left(
  p_round_id uuid,
  p_player_id uuid,
  p_round_started_at timestamptz,
...
notify pgrst, 'reload schema';
-- <<< END 20260811185746_movie_buff_shared_playback_clock_sync.sql
