-- MOV-16 rollback disposition for 20260804073100.
--
-- Migration 20260804073100 replaces the internal eligibility helper introduced
-- by 20260804073000 so category-restricted VIPs fail closed when the match
-- category is null. Rolling back 20260804073100 must therefore restore the exact
-- prior helper contract; it must not drop the helper or any VIP data.
