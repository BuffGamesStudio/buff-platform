-- Reverse only MOV-17 migration 20260804083710.
-- This restores the immediately preceding 83700 activation behavior and does
-- not delete match, participant, phase, leave, score, or board data.
