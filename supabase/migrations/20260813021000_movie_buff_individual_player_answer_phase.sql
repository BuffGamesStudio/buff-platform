-- Movie Buff: answers are individual while the shared phase remains playback.
-- The submit RPC still enforces the caller's own playback clock and active seat.
